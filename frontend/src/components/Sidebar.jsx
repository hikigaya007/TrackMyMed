...
function Sidebar() {
  ...
  return (
    <div className='min-h-screen w-[200px] border-e border-e-black bg-green-500'>
        <ul>
            {sidebardata.map((items , index) => {
                return(
                    <li key={index} className='w-full h-[70px] p-1 pt-5'><NavLink to={items.link} className={'flex p-2 gap-2'}>
                        <div className='size-7'>{items.icon}</div>    
